...
srun ./distributed_train.sh 2 $IMAGENET_FOLDER --model mobilenetv3_large_100 -b 512 --sched step --epochs 300 --decay-epochs 2.4 --decay-rate .973 --opt rmsproptf --opt-eps .001 -j 12 --warmup-lr 1e-6 --weight-decay 1e-5 --drop 0.2 --drop-connect 0.2 --aa rand-m9-mstd0.5 --remode pixel --reprob 0.2 --native-amp --lr .064 --experiment imagenet_inverted --invert-images --no-prefetcher --log-wandb --no-aug --lr-noise 0.42 0.9
